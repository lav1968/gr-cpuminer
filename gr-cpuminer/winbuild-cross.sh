...
cp /usr/x86_64-w64-mingw32/bin/zlib1.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libwinpthread-1.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libstdc++-6.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libgcc_s_seh-1.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libcrypto-1_1-x64.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libcurl-4.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libiconv-2.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libidn2-0.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libpsl-5.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libssp-0.dll bin/win/
cp /usr/x86_64-w64-mingw32/bin/libunistring-2.dll bin/win/
